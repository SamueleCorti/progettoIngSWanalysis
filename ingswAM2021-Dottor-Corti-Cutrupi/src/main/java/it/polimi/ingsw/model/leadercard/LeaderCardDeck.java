...
public class LeaderCardDeck {
    ...
    * converted as LeaderCards.
    ...
    /** this method is used to instantiate the whole deck, getting the list of the card from a json file
     * the cards imported from json are given in the LeaderCardForJson class, and they are here
     * converted as LeaderCards. This is the variant for modified parameters game mode
     */
    public void deckInitializer(String leaderCardsInstancingFA) {
        int i;


        JsonParser parser = new JsonParser();
        JsonArray cardsArray = parser.parse(leaderCardsInstancingFA).getAsJsonArray();
